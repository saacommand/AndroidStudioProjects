package philipng.buttonclickcounter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener OurOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String result = "The button got clicked " + numTimesClicked + " time";
...
//                if (numTimesClicked == 1 )
//                {
//                    ourMessage.setText("The button got clicked " + numTimesClicked + " time.");
//                }
//                else
//                {
//                    ourMessage.setText("The button got clicked " + numTimesClicked + " times.");
//                }
            }
        };
